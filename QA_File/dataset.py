...
from QA_File.QA_utils.folding import process_model
from QA_File.QA_utils.coordinates import place_o_coords
from QA_File.Tri_D import tri_location,tri_location_D
